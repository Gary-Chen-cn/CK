...
<div class="layui-container">
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 50px;">
        <legend>한국어를 중국어로 번역</legend>
    </fieldset>

    <form class="layui-form layui-form-pane" method="post" action="${ctx}/view/index2.jsp">
        <div class="layui-form-item " style="display:none;">
            <label class="layui-form-label">图片翻译</label>
        ...
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">한국어 내용 표시 영역(마침표 빈칸으로 대체)</label>
            <div class="layui-input-block">
                <textarea name="content" id="content" placeholder="내용을 입력해 주세요(마침표 빈칸으로 대체)" style="min-height: 200px" class="layui-textarea">${content}</textarea>
            </div>
        </div>
    ...
    <form class="layui-form layui-form-pane" action="${ctx}/view/index2.jsp">
        <div class="layui-form-item layui-form-text">
