        ...
        <c:forEach items="${msginfoList}" var="v">
            <tr>
                ...
                <td style="width: 180px;">
                    <a href="${ctx}/msginfo/edit?id=${v.msgid}" class="layui-btn layui-btn layui-btn-sm">수정</a>
                    <a href="${ctx}/msginfo/delete?id=${v.msgid}" class="layui-btn layui-btn-danger layui-btn-sm">삭제</a>
