...
<head>
    <meta charset="utf-8">
    <title>JAVA한국어-중국어 시스템-회원가이</title>
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <form id="regForm" action="#" onsubmit="return false;">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="email" id="LAY-user-login-email" lay-verify="email" placeholder="이메일"
                           class="layui-input">
                </div>
                <div class="layui-form-item">
                    <div class="layui-row">
                        <div class="layui-col-xs7">
                            ...
                            <input type="text" name="picurl" id="picurl" lay-verify="required"
                                   placeholder="사용자 프로필 사진을 선택하세요" class="layui-input">
                        </div>
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                                  <span onclick="uploadFileUtilClick('myfile')" class="layui-btn"><i
                                          class="layui-icon"></i>프로필 사진 업로드&nbsp;&nbsp;</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-row">
                        <div class="layui-col-xs7">
                            ...
                            <input type="text" name="vercode" id="LAY-user-login-vercode" lay-verify="required"
                                   placeholder="인증 번호" class="layui-input">
                        </div>
                        <div class="layui-col-xs5">
                            <div style="margin-left: 10px;">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="name" id="LAY-user-login-name" lay-verify="required" placeholder="이름"
                           class="layui-input">
                </div>
                <div class="layui-form-item">
                    <input type="checkbox" name="agreement" lay-skin="primary" title="사용자 협의에 동의하다" checked>
                </div>
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-reg-submit">회원가이</button>
                </div>
                <div class="layui-trans layui-form-item layadmin-user-login-other">
                    <label>소셜 계정 등록</label>
                    <a href="javascript:;"><i class="layui-icon layui-icon-login-qq"></i></a>
                    <a href="javascript:;"><i class="layui-icon layui-icon-login-wechat"></i></a>
                    <a href="javascript:;"><i class="layui-icon layui-icon-login-weibo"></i></a>

                    <a href="${ctx}/view/login.jsp" class="layadmin-user-jump-change layadmin-link layui-hide-xs">기존 계정으로 로그인</a>
                    <a href="${ctx}/view/login.jsp"
                       class="layadmin-user-jump-change layadmin-link layui-hide-sm layui-show-xs-inline-block">로그인</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="layui-trans layadmin-user-login-footer">
        <div class="layui-main">
            <h4>© JAVA한국어-중국어 시스템</h4>
            <p>
     JAVA한국어-중국어 시스템 PC 페이지
            </p>
        </div>
    </div>
</div>
    ...
    layui.config({
        ...
        form.on('submit(LAY-user-reg-submit)', function (obj) {
            ...
            $.post("${ctx}/registerSubmit", regFrom, function (result) {
                if (result.status == 0) {
                    layer.msg('회원가이 완료,로그인 페이지로 로그인하세요', {
                        offset: '15px'
                        , icon: 1
                    }, function () {
