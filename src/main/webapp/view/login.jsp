...
<head>
    <meta charset="utf-8">
    <title>로그인-JAVA한국어-중국어 시스템</title>
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main">
        <div class="layadmin-user-login-box layadmin-user-login-header">
            <h2>JAVA韓中翻譯系統</h2>
            <p> JAVA한국어-중국어 시스템--PC 로그인 페이지</p>
        </div>
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item">
                ...
                <input type="password" name="password" id="LAY-user-login-password" lay-verify="required" value="123456"
                       placeholder="비밀번호" class="layui-input">
            </div>
            <div class="layui-form-item">
                <div class="layui-row">
                    <div class="layui-col-xs7">
                        ...
                        <input type="text" name="vercode" id="LAY-user-login-vercode" lay-verify="required" maxlength="4"
                               placeholder="그래픽 인증번호" class="layui-input">
                    </div>
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;">
                <input type="checkbox" name="remember" lay-skin="primary" title="암호를 기억하기">
                <%--<a href="forget.html" class="layadmin-user-jump-change layadmin-link" style="margin-top: 7px;">忘记密码？</a>--%>
            </div>
            <div class="layui-form-item">
                <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit">로그인</button>
            </div>
            <div class="layui-trans layui-form-item layadmin-user-login-other">
                ...
                <a href="${ctx}/view/register.jsp" class="layadmin-user-jump-change layadmin-link">회원가이하기</a>
            </div>
        </div>
    </div>
