...
<div class="layui-container">
    ...
    <form class="layui-form  layui-form-pane" action="${ctx}/admininfo/update" method="post" style="margin: 50px auto;">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">사용자 번호</label>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">사용자 아이디</label>
				<div class="layui-input-block">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">사용자 비밀번호</label>
				<div class="layui-input-block">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">사용자 역할</label>
				<div class="layui-input-block">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">사용자 프로필 사진</label>
				<div class="layui-input-block">
